...
\begin{itemize}
    \item The Treasury’s solvency condition is given by \eqref{DebtBB}, stated with equality and using the Fisher equation \eqref{eq: Fisher}:
\end{itemize}
...
\vspace{0.35cm}
\begin{itemize}
    \item Treasury solvency requires that the stock of outstanding real debt be backed by the present discounted value of real taxes at any equilibrium path of prices and CB remittances.
\end{itemize}
\end{frame}
...
\begin{itemize}
    \item The key factor in influencing the price level is the formulation of a tax policy.
    \vspace{0.25cm}
